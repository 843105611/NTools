...
public class ComputerDirListAdapter extends BaseAdapter
{
    ...
    public ComputerDirListAdapter(Context context, ArrayList<String> fileList)
    {
...
//编辑逻辑到此结束
    ...
    private Object getUri2(String filePath)
    {
        Object uri = null;
        ...
        if(FileUnit.getType(filePath).equals("dir"))
        {
            ...
            if (FileUnit.getPreDir(filePath).equals(Consts.PC_ROOT) && FileUnit.getType(filePath).equals("dir")) {
